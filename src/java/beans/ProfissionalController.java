...
public class ProfissionalController implements Serializable {
    ...
    private ProfissionalJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new ProfissionalJpaController(Persistence.createEntityManagerFactory("MeuJSF6PU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getProfissionalCount();
                }
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getProfissionalCount();
